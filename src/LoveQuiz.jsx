...
const questions = [
  ...
  return (
    <div className="min-h-screen flex justify-center items-center py-10" style={{ backgroundImage: 'url(/src/assets/khushi4.jpg)', backgroundSize: 'cover', backgroundAttachment: 'fixed' }}>
